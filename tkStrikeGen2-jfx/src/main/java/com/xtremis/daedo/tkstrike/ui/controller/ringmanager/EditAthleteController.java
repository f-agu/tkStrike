...
public class EditAthleteController extends TkStrikeBaseController {
    ...
    if (isFormValid())
      TkStrikeExecutors.executeInThreadPool(new Callable<Void>() {
            public Void call() throws Exception {
              ...
              Flag flagEntity = (Flag)EditAthleteController.this.flagService.getById(EditAthleteController.this.flag.getId());
              try {
  ...
  public LinkedHashSet<FormValidationError> validateForm() {
    ...
    if (StringUtils.isBlank(this.txtWtId.getText())) {
      ...
      res.add(new FormValidationError((Entry)this.currentAthleteEntry, "wtId", (Control)this.txtWtId, getMessage("validation.required")));
    } 
    if (StringUtils.isBlank(this.txtScoreboardName.getText())) {
      if (res == null)
        res = new LinkedHashSet<>(); 
      res.add(new FormValidationError((Entry)this.currentAthleteEntry, "scoreboardName", (Control)this.txtScoreboardName, getMessage("validation.required")));
    } 
    if (StringUtils.isBlank(this.txtFlagAbbr.getText())) {
      if (res == null)
        res = new LinkedHashSet<>(); 
      res.add(new FormValidationError((Entry)this.currentAthleteEntry, "flag", (Control)this.txtFlagAbbr, getMessage("validation.required")));
    } 
    return res;
  }
  ...
  protected Collection<Control> getFormControls() {
    return (Collection<Control>)FXCollections.observableArrayList((Object[])new Control[] { 
          (Control)this.txtWtId, (Control)this.txtOvrInternalId, (Control)this.txtScoreboardName, (Control)this.txtFlagAbbr, (Control)this.txtGivenName, (Control)this.txtFamilyName, (Control)this.txtPassportGivenName, (Control)this.txtPassportFamilyName, (Control)this.txtPreferredGivenName, (Control)this.txtPreferredFamilyName, 
          (Control)this.txtPrintName, (Control)this.txtPrintInitialName, (Control)this.txtTVName, (Control)this.txtTVInitialName, (Control)this.dpBirthDate, (Control)this.tgCompetitorTypeA, (Control)this.tgCompetitorTypeT, (Control)this.tgGenderFEMALE, (Control)this.tgGenderMALE, (Control)this.tgGenderMIXED, 
          (Control)this.txtRank, (Control)this.txtSeed });
  }
  ...
  private void fillAthleteEntryInfo(AthleteEntry athleteEntry) {
    if (athleteEntry != null) {
      ...
      if (athleteEntry.getFlag() != null) {
        ...
        _updateFlag(this.flag, (TextField)this.txtFlagAbbr, this.ivFlag);
      } 
    ...
    TkStrikeExecutors.executeInThreadPool(new Callable<Void>() {
          public Void call() throws Exception {
            ...
            if (EditAthleteController.this.currentAthleteId == null) {
              ...
              try {
                athleteEntry = (AthleteEntry)EditAthleteController.this.athleteService.getEntryById(EditAthleteController.this.currentAthleteId);
  ...
  public void afterPropertiesSet() throws Exception {
    this.txtWtId.textProperty().bindBidirectional((Property)this.currentAthleteEntry.wfId);
    this.txtOvrInternalId.textProperty().bindBidirectional((Property)this.currentAthleteEntry.ovrInternalId);
    this.txtOvrInternalId.setDisable(true);
    this.txtScoreboardName.textProperty().bindBidirectional((Property)this.currentAthleteEntry.scoreboardName);
    this.txtGivenName.textProperty().bindBidirectional((Property)this.currentAthleteEntry.givenName);
    this.txtFamilyName.textProperty().bindBidirectional((Property)this.currentAthleteEntry.familyName);
    this.txtPassportGivenName.textProperty().bindBidirectional((Property)this.currentAthleteEntry.passportGivenName);
    this.txtPassportFamilyName.textProperty().bindBidirectional((Property)this.currentAthleteEntry.passportFamilyName);
    this.txtPreferredGivenName.textProperty().bindBidirectional((Property)this.currentAthleteEntry.preferredGivenName);
    this.txtPreferredFamilyName.textProperty().bindBidirectional((Property)this.currentAthleteEntry.preferredFamilyName);
    this.txtPrintName.textProperty().bindBidirectional((Property)this.currentAthleteEntry.printName);
    this.txtPrintInitialName.textProperty().bindBidirectional((Property)this.currentAthleteEntry.printInitialName);
    this.txtTVName.textProperty().bindBidirectional((Property)this.currentAthleteEntry.tvName);
    this.txtTVInitialName.textProperty().bindBidirectional((Property)this.currentAthleteEntry.tvInitialName);
    this.dpBirthDate.valueProperty().addListener(new ChangeListener<LocalDate>() {
          public void changed(ObservableValue<? extends LocalDate> observable, LocalDate oldValue, LocalDate newValue) {
            EditAthleteController.this.currentAthleteEntry.setBirthDate((newValue != null) ? EditAthleteController.this.convertToDateViaInstant(newValue) : null);
          }
        });
    this.currentAthleteEntry.birthDateProperty().addListener(new ChangeListener<Date>() {
          public void changed(ObservableValue<? extends Date> observable, Date oldValue, Date newValue) {
            EditAthleteController.this.dpBirthDate.setValue((newValue != null) ? EditAthleteController.this.convertToLocalDateViaMilisecond(newValue) : null);
          }
        });
          ...
          public void changed(ObservableValue<? extends CompetitorType> observable, CompetitorType oldValue, CompetitorType newValue) {
            if (newValue != null) {
              if (CompetitorType.A.equals(newValue)) {
                EditAthleteController.this.tgCompetitorType.selectToggle((Toggle)EditAthleteController.this.tgCompetitorTypeA);
              } else {
                EditAthleteController.this.tgCompetitorType.selectToggle((Toggle)EditAthleteController.this.tgCompetitorTypeT);
              } 
            } else {
          ...
          public void changed(ObservableValue<? extends Gender> observable, Gender oldValue, Gender newValue) {
            if (newValue != null) {
              if (Gender.MALE.equals(newValue)) {
                EditAthleteController.this.tgGender.selectToggle((Toggle)EditAthleteController.this.tgGenderMALE);
              } else if (Gender.FEMALE.equals(newValue)) {
                EditAthleteController.this.tgGender.selectToggle((Toggle)EditAthleteController.this.tgGenderFEMALE);
              } else {
                EditAthleteController.this.tgGender.selectToggle((Toggle)EditAthleteController.this.tgGenderMIXED);
              } 
            } else {
          ...
          public void changed(ObservableValue<? extends Boolean> observableValue, Boolean aBoolean, final Boolean t1) {
            Platform.runLater(new Runnable() {
                  public void run() {
                    ...
                    if (t1.booleanValue())
                      color = Color.GREEN; 
                    EditAthleteController.this.ciExists.setFill((Paint)color);
                  }
                });
          }
        });
            ...
            if (!t1.booleanValue() && StringUtils.isNotBlank(EditAthleteController.this.txtWtId.getText()))
              TkStrikeExecutors.executeInThreadPool(new Callable<Void>() {
                    public Void call() throws Exception {
                      EditAthleteController.this.showProgressIndicator(true);
                      try {
                        AthleteEntry athleteEntry = EditAthleteController.this.athleteService.getEntryBytWfId(EditAthleteController.this.txtWtId.getText());
                        ...
                        EditAthleteController.this.manageException((Throwable)e, null, e.getMessage());
                        e.printStackTrace();
                      } finally {
                        EditAthleteController.this.showProgressIndicator(false);
                      } 
    ...
    this.txtFlagAbbr.focusedProperty().addListener(new ChangeListener<Boolean>() {
          public void changed(ObservableValue<? extends Boolean> observableValue, Boolean aBoolean, Boolean t1) {
            if (!t1.booleanValue() && EditAthleteController.this.txtFlagAbbr.getText() != null)
              try {
                FlagEntry flagEntry = EditAthleteController.this.flagService.getEntryByAbbreviation(EditAthleteController.this.txtFlagAbbr.getText().toUpperCase());
                if (flagEntry != null) {
                  EditAthleteController.this.flag = flagEntry;
                } else {
                  EditAthleteController.this.flag = null;
                } 
                EditAthleteController.this._updateFlag(EditAthleteController.this.flag, (TextField)EditAthleteController.this.txtFlagAbbr, EditAthleteController.this.ivFlag);
              } catch (TkStrikeServiceException e) {
                e.printStackTrace();
              }  
          }
