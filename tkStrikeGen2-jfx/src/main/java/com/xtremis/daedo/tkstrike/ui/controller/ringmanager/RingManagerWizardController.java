...
public class RingManagerWizardController extends TkStrikeBaseController {
    ...
    Platform.runLater(new Runnable() {
          public void run() {
            ...
            try {
              ...
              RingManagerWizardController.this.manageException((Throwable)e, "getRulesEntry", null);
            } 
            if (rulesEntry != null) {
  ...
  public void doFinish() {
    ...
    if (currController.isFormValid()) {
      ...
      try {
        this.matchConfigurationEntry = (MatchConfigurationEntry)this.matchConfigurationService.createByEntry((IMatchConfigurationEntry)this.matchConfigurationEntry);
        this.wizardFinished = true;
        this.wizardCanceled = false;
        doCloseThisStage();
      } catch (TkStrikeServiceException e) {
        manageException((Throwable)e, "Create MatchConfiguration", null);
      } 
    } 
  }
  ...
  private void _doBreadcrumb() {
    if (this.matchConfigurationEntry != null) {
      ...
      if (this.currentStep.get() > 1 && this.matchConfigurationEntry.getPhase() != null && this.matchConfigurationEntry.getPhase().getId() != null) {
        this.lblPhase.setText(this.matchConfigurationEntry.getPhase().getName() + " >");
      } else {
        this.lblPhase.setText("");
      } 
      if (this.currentStep.get() > 2 && this.matchConfigurationEntry.getSubCategory() != null && this.matchConfigurationEntry.getSubCategory().getId() != null) {
      ...
      if (this.currentStep.get() > 4 && this.matchConfigurationEntry.getCategory() != null && this.matchConfigurationEntry.getCategory().getId() != null) {
