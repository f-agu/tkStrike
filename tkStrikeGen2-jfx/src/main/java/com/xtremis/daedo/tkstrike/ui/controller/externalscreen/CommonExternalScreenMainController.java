...
public abstract class CommonExternalScreenMainController<NE extends INetworkConfigurationEntry, ESB extends ExternalScoreboardController, EHTA extends TkStrikeController, EHTJ extends TkStrikeController> extends CommonTkStrikeBaseController<NE> {
  @FXML
  ...
  public EventHandler<WindowEvent> getOnWindowCloseEventHandler() {
    return new EventHandler<WindowEvent>() {
        public void handle(WindowEvent windowEvent) {
          CommonExternalScreenMainController.this.getExternalScoreboardController().getOnWindowCloseEventHandler().handle((Event)windowEvent);
          CommonExternalScreenMainController.this.getExternalHTAthletesController().getOnWindowCloseEventHandler().handle((Event)windowEvent);
          CommonExternalScreenMainController.this.getExternalHTJudgesController().getOnWindowCloseEventHandler().handle((Event)windowEvent);
        }
      };
  }
  ...
  public void afterPropertiesSet() throws Exception {
    getAppStatusWorker().externalScreenViewProperty().addListener(new ChangeListener<ExternalScreenViewId>() {
          public void changed(ObservableValue<? extends ExternalScreenViewId> observableValue, ExternalScreenViewId externalScreenViewId, ExternalScreenViewId newScreenView) {
