...
public class AthletesInformationController extends BaseStepWizardController implements StepWizardController {
  ...
  protected Collection<Control> getFormControls() {
    return (Collection<Control>)FXCollections.observableArrayList((Object[])new Control[] { (Control)this.txtBlueName, (Control)this.txtBlueWTFID, (Control)this.txtBlueAbbr, (Control)this.txtRedName, (Control)this.txtRedWTFID, (Control)this.txtRedAbbr });
  }
  ...
  public LinkedHashSet<FormValidationError> validateForm() {
    ...
    if (StringUtils.isBlank(this.txtBlueName.getText())) {
      ...
      res.add(new FormValidationError((Entry)this.matchConfigurationEntry, "blueAthlete.name", (Control)this.txtBlueName, getMessage("validation.required")));
    } 
    if (StringUtils.isBlank(this.txtRedName.getText())) {
      if (res == null)
        res = new LinkedHashSet<>(); 
      res.add(new FormValidationError((Entry)this.matchConfigurationEntry, "redAthlete.name", (Control)this.txtRedName, getMessage("validation.required")));
    } 
    return res;
  }
  ...
  public void onWindowShowEvent() {
    ...
    this.ciBlueExists.setFill((Paint)Color.RED);
    this.ciRedExists.setFill((Paint)Color.RED);
    this.blueExists.set(false);
    this.redExists.set(false);
  }
  ...
  protected void _bindControls() {
    ...
    if (this.matchConfigurationEntry != null) {
      this.txtBlueVrQuota.textProperty().bindBidirectional((Property)this.matchConfigurationEntry.blueAthleteVideoQuotaProperty(), (StringConverter)new NumberStringConverter());
      this.txtRedVrQuota.textProperty().bindBidirectional((Property)this.matchConfigurationEntry.redAthleteVideoQuotaProperty(), (StringConverter)new NumberStringConverter());
    } 
  }
  
  protected void _bindBlueInfo() {
    if (this.matchConfigurationEntry != null) {
      final AthleteEntry blueAthleteEntry = (AthleteEntry)this.matchConfigurationEntry.blueAthleteProperty().get();
      if (blueAthleteEntry != null)
        Platform.runLater(new Runnable() {
              public void run() {
                AthletesInformationController.this.txtBlueName.textProperty().bindBidirectional((Property)blueAthleteEntry.scoreboardName);
                AthletesInformationController.this.txtBlueWTFID.textProperty().bindBidirectional((Property)blueAthleteEntry.wfId);
                if (blueAthleteEntry.flag.get() != null) {
                  AthletesInformationController.this.blueFlag = (FlagEntry)blueAthleteEntry.flag.get();
                  if (AthletesInformationController.this.blueFlag != null)
                    AthletesInformationController.this._updateFlag(AthletesInformationController.this.blueFlag, (TextField)AthletesInformationController.this.txtBlueAbbr, AthletesInformationController.this.ivBlueFlag); 
                } 
              }
            }); 
    } 
  ...
  protected void _bindRedInfo() {
    if (this.matchConfigurationEntry != null) {
      final AthleteEntry redAthleteEntry = (AthleteEntry)this.matchConfigurationEntry.redAthleteProperty().get();
      if (redAthleteEntry != null)
        Platform.runLater(new Runnable() {
              public void run() {
                AthletesInformationController.this.txtRedName.textProperty().bindBidirectional((Property)redAthleteEntry.scoreboardName);
                AthletesInformationController.this.txtRedWTFID.textProperty().bindBidirectional((Property)redAthleteEntry.wfId);
                if (redAthleteEntry.flag.get() != null) {
                  AthletesInformationController.this.redFlag = (FlagEntry)redAthleteEntry.flag.get();
                  if (AthletesInformationController.this.redFlag != null)
                    AthletesInformationController.this._updateFlag(AthletesInformationController.this.redFlag, (TextField)AthletesInformationController.this.txtRedAbbr, AthletesInformationController.this.ivRedFlag); 
                } 
              }
            }); 
    } 
  ...
  public void editBlueAthlete() {
    createOrUpdateAthlete(((AthleteEntry)this.matchConfigurationEntry.blueAthleteProperty().get()).getId(), true);
  }
  ...
  private void createOrUpdateAthlete(String athleteId, final boolean blue) {
    ...
    openInNewStage((TkStrikeController)this.editAthleteController, new EventHandler<WindowEvent>() {
          public void handle(WindowEvent event) {
            if (AthletesInformationController.this.editAthleteController.isSaved() && AthletesInformationController.this.editAthleteController.getCurrentAthleteId() != null) {
              AthleteEntry athleteEntry = null;
              try {
                athleteEntry = (AthleteEntry)AthletesInformationController.this.athleteService.getEntryById(AthletesInformationController.this.editAthleteController.getCurrentAthleteId());
              } catch (TkStrikeServiceException e) {
                AthletesInformationController.this.manageException((Throwable)e, null, e.getMessage());
              } 
              if (blue) {
  ...
  public MatchConfigurationEntry getMatchConfigurationEntry() {
    ((AthleteEntry)this.matchConfigurationEntry.blueAthleteProperty().get()).flag.set(this.blueFlag);
    ((AthleteEntry)this.matchConfigurationEntry.redAthleteProperty().get()).flag.set(this.redFlag);
  ...
  public void initialize(URL url, ResourceBundle resourceBundle) {
          ...
          public void changed(ObservableValue<? extends Boolean> observableValue, Boolean aBoolean, final Boolean t1) {
            Platform.runLater(new Runnable() {
                  public void run() {
                    ...
                    if (t1.booleanValue())
                      color = Color.GREEN; 
                    AthletesInformationController.this.ciBlueExists.setFill((Paint)color);
                  }
                });
          }
        });
    this.btEditBlue.visibleProperty().bind((ObservableValue)this.blueExists);
          ...
          public void changed(ObservableValue<? extends Boolean> observableValue, Boolean aBoolean, final Boolean t1) {
            Platform.runLater(new Runnable() {
                  public void run() {
                    ...
                    if (t1.booleanValue())
                      color = Color.GREEN; 
                    AthletesInformationController.this.ciRedExists.setFill((Paint)color);
                  }
                });
          }
        });
    this.btEditRed.visibleProperty().bind((ObservableValue)this.redExists);
    this.txtBlueWTFID.focusedProperty().addListener(new ChangeListener<Boolean>() {
          public void changed(ObservableValue<? extends Boolean> observableValue, Boolean aBoolean, Boolean t1) {
            if (!t1.booleanValue())
              try {
                AthleteEntry athleteEntry = AthletesInformationController.this.athleteService.getEntryBytWfId(AthletesInformationController.this.txtBlueWTFID.getText());
                if (athleteEntry != null && athleteEntry.getId() != null) {
                  AthletesInformationController.this.matchConfigurationEntry.blueAthleteProperty().set(athleteEntry);
                  AthletesInformationController.this.blueExists.setValue(Boolean.valueOf(true));
                } else {
                  ((AthleteEntry)AthletesInformationController.this.matchConfigurationEntry.blueAthleteProperty().get()).id.set(null);
    ...
    this.txtBlueAbbr.focusedProperty().addListener(new ChangeListener<Boolean>() {
          public void changed(ObservableValue<? extends Boolean> observableValue, Boolean aBoolean, Boolean t1) {
            if (!t1.booleanValue() && AthletesInformationController.this.txtBlueAbbr.getText() != null)
              try {
                FlagEntry flagEntry = AthletesInformationController.this.flagService.getEntryByAbbreviation(AthletesInformationController.this.txtBlueAbbr.getText().toUpperCase());
                if (flagEntry != null) {
    ...
    this.txtRedWTFID.focusedProperty().addListener(new ChangeListener<Boolean>() {
          public void changed(ObservableValue<? extends Boolean> observableValue, Boolean aBoolean, Boolean t1) {
            if (!t1.booleanValue())
              try {
                AthleteEntry athleteEntry = AthletesInformationController.this.athleteService.getEntryBytWfId(AthletesInformationController.this.txtRedWTFID.getText());
                if (athleteEntry != null && athleteEntry.getId() != null) {
                  AthletesInformationController.this.matchConfigurationEntry.redAthleteProperty().set(athleteEntry);
                  AthletesInformationController.this.redExists.set(true);
                } else {
                  ((AthleteEntry)AthletesInformationController.this.matchConfigurationEntry.redAthleteProperty().get()).id.set(null);
    ...
    this.txtRedAbbr.focusedProperty().addListener(new ChangeListener<Boolean>() {
          public void changed(ObservableValue<? extends Boolean> observableValue, Boolean aBoolean, Boolean t1) {
            if (!t1.booleanValue() && AthletesInformationController.this.txtRedAbbr.getText() != null)
              try {
                FlagEntry flagEntry = AthletesInformationController.this.flagService.getEntryByAbbreviation(AthletesInformationController.this.txtRedAbbr.getText().toUpperCase());
                if (flagEntry != null) {
