...
public abstract class NetworkStatusBaseController extends TkStrikeBaseController implements TkStrikeCommunicationListener, GlobalNetworkStatusControllerListener {
    ...
    TkStrikeExecutors.executeInThreadPool(new Runnable() {
          public void run() {
            ...
            if (NetworkStatusBaseController.this.hasUIStatus())
              NetworkStatusBaseController.this.txtNetworkStatus().setText(NetworkStatusBaseController.this.getMessage("label.networkStatus." + NetworkStatusBaseController.this.tkStrikeCommunicationService.getCurrentNetworkStatus().toString())); 
    ...
    return new EventHandler<WindowEvent>() {
        public void handle(WindowEvent windowEvent) {
          if (NetworkStatusBaseController.logger.isDebugEnabled())
            NetworkStatusBaseController.logger.debug("On Window Close Event, REMOVE listener ?" + NetworkStatusBaseController.this.removeListenerWhenCloseWindow); 
    ...
    Platform.runLater(new Runnable() {
          public void run() {
            if (NetworkStatusBaseController.this.hasUIJudges()) {
              NetworkStatusBaseController.this.txtJ1Battery().textProperty().bind((ObservableValue)NetworkStatusBaseController.this.j1Battery);
              NetworkStatusBaseController.this.txtJ2Battery().textProperty().bind((ObservableValue)NetworkStatusBaseController.this.j2Battery);
              NetworkStatusBaseController.this.txtJ3Battery().textProperty().bind((ObservableValue)NetworkStatusBaseController.this.j3Battery);
              NetworkStatusBaseController.this.hbJudge1().visibleProperty().bind((ObservableValue)NetworkStatusBaseController.this.currentNetworkConfiguration.judge1EnabledProperty);
              NetworkStatusBaseController.this.hbJudge2().visibleProperty().bind((ObservableValue)NetworkStatusBaseController.this.currentNetworkConfiguration.judge2EnabledProperty);
              NetworkStatusBaseController.this.hbJudge3().visibleProperty().bind((ObservableValue)NetworkStatusBaseController.this.currentNetworkConfiguration.judge3EnabledProperty);
            } 
            if (NetworkStatusBaseController.this.hasUIAthletes()) {
              NetworkStatusBaseController.this.txtG1BBBattery().textProperty().bind((ObservableValue)NetworkStatusBaseController.this.g1BBBattery);
              NetworkStatusBaseController.this.txtG1HBBattery().textProperty().bind((ObservableValue)NetworkStatusBaseController.this.g1HBBattery);
              NetworkStatusBaseController.this.txtG1BRBattery().textProperty().bind((ObservableValue)NetworkStatusBaseController.this.g1BRBattery);
              NetworkStatusBaseController.this.txtG1HRBattery().textProperty().bind((ObservableValue)NetworkStatusBaseController.this.g1HRBattery);
              NetworkStatusBaseController.this.txtG2BBBattery().textProperty().bind((ObservableValue)NetworkStatusBaseController.this.g2BBBattery);
              NetworkStatusBaseController.this.txtG2HBBattery().textProperty().bind((ObservableValue)NetworkStatusBaseController.this.g2HBBattery);
              NetworkStatusBaseController.this.txtG2BRBattery().textProperty().bind((ObservableValue)NetworkStatusBaseController.this.g2BRBattery);
              NetworkStatusBaseController.this.txtG2HRBattery().textProperty().bind((ObservableValue)NetworkStatusBaseController.this.g2HRBattery);
            } 
  ...
  public void hasNewNodeNetworkErrorEvent(final GlobalNetworkStatusControllerListener.NodeNetworkErrorEvent nodeNetworkErrorEvent) {
    if (nodeNetworkErrorEvent != null && nodeNetworkErrorEvent.getNetworkNode() != null) {
      ...
      if (hasUIAthletes())
        if (this.currentNetworkConfiguration.getGroup1Config() != null && nodeNetworkErrorEvent.getNetworkNode().getNodeId().equals(this.currentNetworkConfiguration.getGroup1Config().getBodyBlueNodeId())) {
          rectangle = stG1BB();
          pctProperty = this.g1BBBattery;
        } else if (this.currentNetworkConfiguration.getGroup1Config() != null && nodeNetworkErrorEvent.getNetworkNode().getNodeId().equals(this.currentNetworkConfiguration.getGroup1Config().getHeadBlueNodeId())) {
          rectangle = stG1HB();
          pctProperty = this.g1HBBattery;
        } else if (this.currentNetworkConfiguration.getGroup1Config() != null && nodeNetworkErrorEvent.getNetworkNode().getNodeId().equals(this.currentNetworkConfiguration.getGroup1Config().getBodyRedNodeId())) {
          rectangle = stG1BR();
          pctProperty = this.g1BRBattery;
        } else if (this.currentNetworkConfiguration.getGroup1Config() != null && nodeNetworkErrorEvent.getNetworkNode().getNodeId().equals(this.currentNetworkConfiguration.getGroup1Config().getHeadRedNodeId())) {
          rectangle = stG1HR();
          pctProperty = this.g1HRBattery;
        } else if (this.currentNetworkConfiguration.getGroup2Config() != null && nodeNetworkErrorEvent.getNetworkNode().getNodeId().equals(this.currentNetworkConfiguration.getGroup2Config().getBodyBlueNodeId())) {
          rectangle = stG2BB();
          pctProperty = this.g2BBBattery;
        } else if (this.currentNetworkConfiguration.getGroup2Config() != null && nodeNetworkErrorEvent.getNetworkNode().getNodeId().equals(this.currentNetworkConfiguration.getGroup2Config().getHeadBlueNodeId())) {
          rectangle = stG2HB();
          pctProperty = this.g2HBBattery;
        } else if (this.currentNetworkConfiguration.getGroup2Config() != null && nodeNetworkErrorEvent.getNetworkNode().getNodeId().equals(this.currentNetworkConfiguration.getGroup2Config().getBodyRedNodeId())) {
          rectangle = stG2BR();
          pctProperty = this.g2BRBattery;
        } else if (this.currentNetworkConfiguration.getGroup2Config() != null && nodeNetworkErrorEvent.getNetworkNode().getNodeId().equals(this.currentNetworkConfiguration.getGroup2Config().getHeadRedNodeId())) {
          rectangle = stG2HR();
      ...
      if (rectangle != null) {
        ...
        Platform.runLater(new Runnable() {
              public void run() {
                if (offLine) {
                  theShape.setFill((Paint)Color.RED);
                  thePctProperty.set("");
                } else if (sensorKO) {
                  if (NetworkStatusBaseController.this.isTkStrikeGen2Version()) {
                    ...
                    thePctProperty.set(CommonTkStrikeBaseController.pctFormat.format(nodeNetworkErrorEvent.getNetworkNode().getBatteryPct()));
                  } 
                  theShape.setFill((Paint)Color.ORANGE);
                } 
              }
            });
      } 
  ...
  public void hasNewGlobalStatusEvent(StatusEvent statusEvent) {
    if (statusEvent != null && statusEvent.getNodeId() != null) {
      ...
      if (hasUIAthletes())
        if (this.currentNetworkConfiguration.getGroup1Config() != null && statusEvent.getNodeId().equals(this.currentNetworkConfiguration.getGroup1Config().getBodyBlueNodeId())) {
          rectangle = stG1BB();
          pctProperty = this.g1BBBattery;
        } else if (this.currentNetworkConfiguration.getGroup1Config() != null && statusEvent.getNodeId().equals(this.currentNetworkConfiguration.getGroup1Config().getHeadBlueNodeId())) {
          rectangle = stG1HB();
          pctProperty = this.g1HBBattery;
        } else if (this.currentNetworkConfiguration.getGroup1Config() != null && statusEvent.getNodeId().equals(this.currentNetworkConfiguration.getGroup1Config().getBodyRedNodeId())) {
          rectangle = stG1BR();
          pctProperty = this.g1BRBattery;
        } else if (this.currentNetworkConfiguration.getGroup1Config() != null && statusEvent.getNodeId().equals(this.currentNetworkConfiguration.getGroup1Config().getHeadRedNodeId())) {
          rectangle = stG1HR();
          pctProperty = this.g1HRBattery;
        } else if (this.currentNetworkConfiguration.getGroup2Config() != null && statusEvent.getNodeId().equals(this.currentNetworkConfiguration.getGroup2Config().getBodyBlueNodeId())) {
          rectangle = stG2BB();
          pctProperty = this.g2BBBattery;
        } else if (this.currentNetworkConfiguration.getGroup2Config() != null && statusEvent.getNodeId().equals(this.currentNetworkConfiguration.getGroup2Config().getHeadBlueNodeId())) {
          rectangle = stG2HB();
          pctProperty = this.g2HBBattery;
        } else if (this.currentNetworkConfiguration.getGroup2Config() != null && statusEvent.getNodeId().equals(this.currentNetworkConfiguration.getGroup2Config().getBodyRedNodeId())) {
          rectangle = stG2BR();
          pctProperty = this.g2BRBattery;
        } else if (this.currentNetworkConfiguration.getGroup2Config() != null && statusEvent.getNodeId().equals(this.currentNetworkConfiguration.getGroup2Config().getHeadRedNodeId())) {
          rectangle = stG2HR();
          pctProperty = this.g2HRBattery;
        }  
      if (rectangle != null) {
        ...
        Platform.runLater(new Runnable() {
              public void run() {
                ...
                if (connOffline) {
                  ...
                  theShape.setFill((Paint)Color.GREEN);
                } else {
                  theShape.setFill((Paint)Color.ORANGE);
                } 
              }
  ...
  public final void hasChangeNetworkStatusEvent(final ChangeNetworkStatusEvent changeNetworkStatusEvent) {
    if (hasUIStatus())
      Platform.runLater(new Runnable() {
            public void run() {
              NetworkStatusBaseController.this.txtNetworkStatus().setText(NetworkStatusBaseController.this.getMessage("label.networkStatus." + changeNetworkStatusEvent.getNetworkStatus().toString()));
              switch (changeNetworkStatusEvent.getNetworkStatus()) {
                case OK:
                  NetworkStatusBaseController.this.reNetworkStatus().setFill((Paint)Color.GREEN);
                  NetworkStatusBaseController.this.getAppStatusWorker().setNetworkConfigurationEntry((INetworkConfigurationEntry)NetworkStatusBaseController.this.getCurrentNetworkConfiguration());
                  break;
                case ANALYZING:
                  NetworkStatusBaseController.this.reNetworkStatus().setFill((Paint)Color.ORANGE);
                  break;
                case NOT_RECOGNIZED:
                case NOT_STARTED:
                  NetworkStatusBaseController.this.reNetworkStatus().setFill((Paint)Color.RED);
                  break;
                case NOT_CONNECTED:
                  NetworkStatusBaseController.this.reNetworkStatus().setFill((Paint)Color.web("cdcfd0"));
                  break;
              } 
