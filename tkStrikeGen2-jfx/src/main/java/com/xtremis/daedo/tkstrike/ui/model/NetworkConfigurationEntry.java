...
public class NetworkConfigurationEntry implements INetworkConfigurationEntry<NetworkConfiguration> {
	...
	public void fillByEntity(NetworkConfiguration entity) {
		if(entity != null) {
			...
			group1.fillByEntity(entity.getGroup1Config());
	...
	public NetworkConfigurationDto getNetworkConfigurationDto() {
		NetworkConfigurationDto res = new NetworkConfigurationDto(Integer.valueOf((this.group2EnabledProperty.get() && getGroupsNumber() == 1) ? 2
				: getGroupsNumber()));
		BeanUtils.copyProperties(this, res, new String[] {"group1Config", "group2Config", "group3Config", "group4Config", "group5Config",
				"group6Config"});
	...
	public Property getChannelNumberProperty() {
		return this.channelNumberProperty;
	}

	@Override
	public Property getJudgesNumberProperty() {
		return this.judgesNumberProperty;
	}
	...
	public NetworkAthletesGroupConfigEntry getGroup1Config() {
		return this.group1ConfigProperty.get();
	}
