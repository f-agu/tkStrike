...
public class ConfigurationExternalConfigController extends TkStrikeBaseController {
  ...
  private SimpleBooleanProperty rtBroadcastRingNumberChanged = new SimpleBooleanProperty(this, "rtBroadcastRingNumberChanged", Boolean.FALSE.booleanValue());
  ...
  protected boolean reallyCanClose() {
    if (!this.formSaved.get() && (this.rtBroadcastIpChanged.get() || this.rtBroadcastRingNumberChanged.get() || this.rtBroadcastPortChanged.get()) && (
      (ButtonType)showConfirmDialog(getMessage("message.confirmDialog.title"), 
  ...
  private void refreshExternalConfigAndRebind() {
    ...
    try {
      ...
      manageException((Throwable)e, "refreshExternalConfigAndRebind - getExternalConfigEntry", null);
    } 
    Platform.runLater(new Runnable() {
          public void run() {
            ConfigurationExternalConfigController.this.pnTkStrikeVM.setVisible(!ConfigurationExternalConfigController.this.wtCompetitionDataProtocol.booleanValue());
            ConfigurationExternalConfigController.this.pnWTOvr.setVisible(ConfigurationExternalConfigController.this.wtCompetitionDataProtocol.booleanValue());
            ConfigurationExternalConfigController.this.txtWTOvrUrl.textProperty().bindBidirectional((Property)ConfigurationExternalConfigController.this.currentExternalConfigEntry.wtOvrUrlProperty());
            ConfigurationExternalConfigController.this.txtWTOvrXApiKey.textProperty().bindBidirectional((Property)ConfigurationExternalConfigController.this.currentExternalConfigEntry.wtOvrXApiKeyProperty());
            ConfigurationExternalConfigController.this.txtWTOvrMat.textProperty().bindBidirectional((Property)ConfigurationExternalConfigController.this.currentExternalConfigEntry.wtOvrMatProperty(), (StringConverter)new NumberStringConverter());
            ConfigurationExternalConfigController.this.txtWTOvrUdpIp.textProperty().bindBidirectional((Property)ConfigurationExternalConfigController.this.currentExternalConfigEntry.wtOvrUdpIpProperty());
            ConfigurationExternalConfigController.this.txtWTOvrUdpListenPort.textProperty().bindBidirectional((Property)ConfigurationExternalConfigController.this.currentExternalConfigEntry.wtOvrUdpListenPortProperty(), (StringConverter)new NumberStringConverter("0000"));
            ConfigurationExternalConfigController.this.txtWTOvrUdpWritePort.textProperty().bindBidirectional((Property)ConfigurationExternalConfigController.this.currentExternalConfigEntry.wtOvrUdpWritePortProperty(), (StringConverter)new NumberStringConverter("0000"));
            ConfigurationExternalConfigController.this.tgOvrXApiKey.setSelected(StringUtils.isNotBlank(ConfigurationExternalConfigController.this.currentExternalConfigEntry.getWtOvrXApiKey()));
            ConfigurationExternalConfigController.this.txtVenueManagementURL.textProperty().bindBidirectional((Property)ConfigurationExternalConfigController.this.currentExternalConfigEntry.venueManagementURLProperty());
            ConfigurationExternalConfigController.this.txtVenueManagementRingNumber.textProperty().bindBidirectional((Property)ConfigurationExternalConfigController.this.currentExternalConfigEntry.venueManagementRingNumberProperty());
            ConfigurationExternalConfigController.this.cmbScreenRessolution.valueProperty().bindBidirectional((Property)ConfigurationExternalConfigController.this.currentExternalConfigEntry.extScoreboardResolutionProperty());
            ConfigurationExternalConfigController.this.rbBlueOnLeft.selectedProperty().bindBidirectional((Property)ConfigurationExternalConfigController.this.currentExternalConfigEntry.extScoreboardBlueOnLeftProperty());
            ...
            if (ConfigurationExternalConfigController.this.currentExternalConfigEntry.getListenersURLs() != null && ConfigurationExternalConfigController.this.currentExternalConfigEntry.getListenersURLs().size() > 0)
              for (String listenerURL : ConfigurationExternalConfigController.this.currentExternalConfigEntry.getListenersURLs())
                ConfigurationExternalConfigController.this.createNewEventsListenerComponent(listenerURL, ConfigurationExternalConfigController.this.pnEventListeners, (TkStrikeCommonEventListenerClient)ConfigurationExternalConfigController.this.tkStrikeEventsListenerClient);  
            ConfigurationExternalConfigController.this.pnNodeEventListeners.getChildren().clear();
            if (ConfigurationExternalConfigController.this.currentExternalConfigEntry.getNodeListenersURLs() != null && ConfigurationExternalConfigController.this.currentExternalConfigEntry.getNodeListenersURLs().size() > 0)
              for (String listenerURL : ConfigurationExternalConfigController.this.currentExternalConfigEntry.getNodeListenersURLs())
                ConfigurationExternalConfigController.this.createNewEventsListenerComponent(listenerURL, ConfigurationExternalConfigController.this.pnNodeEventListeners, (TkStrikeCommonEventListenerClient)ConfigurationExternalConfigController.this.tkStrikeNodeEventsListenerClient);  
            ConfigurationExternalConfigController.this.pnUDPEventListeners.getChildren().clear();
            try {
              List<UdpEventListenerEntry> eventListenerEntryList = ConfigurationExternalConfigController.this.udpEventListenerService.findAllEntries();
              if (eventListenerEntryList != null && eventListenerEntryList.size() > 0)
                for (UdpEventListenerEntry entry : eventListenerEntryList)
                  ConfigurationExternalConfigController.this.createNewUDPEventsListenerComponent(entry, ConfigurationExternalConfigController.this.pnUDPEventListeners);  
            } catch (TkStrikeServiceException e) {
              ConfigurationExternalConfigController.this.manageException((Throwable)e, "refreshExternalConfigAndRebind - udpEventListenerService", null);
            } 
            ConfigurationExternalConfigController.this.txtRtBroadcastIp.textProperty().bindBidirectional((Property)ConfigurationExternalConfigController.this.currentExternalConfigEntry.rtBroadcastIpProperty());
            ConfigurationExternalConfigController.this.txtRtBroadcastPort.textProperty().bindBidirectional((Property)ConfigurationExternalConfigController.this.currentExternalConfigEntry.rtBroadcastPortProperty(), (StringConverter)new NumberStringConverter("0000"));
            ConfigurationExternalConfigController.this.txtRtBroadcastRingNumber.textProperty().bindBidirectional((Property)ConfigurationExternalConfigController.this.currentExternalConfigEntry.rtBroadcastRingNumberProperty());
  ...
  protected Collection<Control> getFormControls() {
    ...
    return (Collection<Control>)FXCollections.observableArrayList(theList);
  }
  ...
  public LinkedHashSet<FormValidationError> validateForm() {
    ...
    if (StringUtils.isNotBlank(this.txtRtBroadcastIp.getText()) && 
      !this.txtRtBroadcastIp.getText().matches("^(([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])\\.){3}([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])$") && 
      !this.txtRtBroadcastIp.getText().matches("^(([a-zA-Z0-9]|[a-zA-Z0-9][a-zA-Z0-9\\-]*[a-zA-Z0-9])\\.)*([A-Za-z0-9]|[A-Za-z0-9][A-Za-z0-9\\-]*[A-Za-z0-9])$")) {
      res = new LinkedHashSet<>();
      res.add(new FormValidationError((Entry)this.currentExternalConfigEntry, "rtBroadcastIp", (Control)this.txtRtBroadcastIp, getMessage("validation.invalidURL")));
    } 
    if (this.wtCompetitionDataProtocol.booleanValue()) {
      if (StringUtils.isNotBlank(this.txtWTOvrUrl.getText()) && !this.txtWTOvrUrl.getText().matches("^(https?|ftp|file)://[-a-zA-Z0-9+&@#/%?=~_|!:,.;]*[-a-zA-Z0-9+&@#/%=~_|]")) {
        if (res == null)
          res = new LinkedHashSet<>(); 
        res.add(new FormValidationError((Entry)this.currentExternalConfigEntry, "wtOvrUlr", (Control)this.txtWTOvrUrl, getMessage("validation.invalidURL")));
      } 
      if (StringUtils.isNotBlank(this.txtWTOvrUrl.getText()) && StringUtils.isBlank(this.txtWTOvrMat.getText())) {
        if (res == null)
          res = new LinkedHashSet<>(); 
        res.add(new FormValidationError((Entry)this.currentExternalConfigEntry, "txtWTOvrMat", (Control)this.txtWTOvrMat, getMessage("validation.required")));
      } else if (!StringUtils.isNumeric(this.txtWTOvrMat.getText())) {
        if (res == null)
          res = new LinkedHashSet<>(); 
        res.add(new FormValidationError((Entry)this.currentExternalConfigEntry, "txtWTOvrMat", (Control)this.txtWTOvrMat, getMessage("validation.invalidNumber")));
      } 
      if (this.tgOvrXApiKey.isSelected() && StringUtils.isBlank(this.txtWTOvrXApiKey.getText())) {
        if (res == null)
          res = new LinkedHashSet<>(); 
        res.add(new FormValidationError((Entry)this.currentExternalConfigEntry, "txtWTOvrXApiKey", (Control)this.txtWTOvrXApiKey, getMessage("validation.required")));
      } 
    } else {
      if (StringUtils.isNotBlank(this.txtVenueManagementURL.getText()) && !this.txtVenueManagementURL.getText().matches("^(https?|ftp|file)://[-a-zA-Z0-9+&@#/%?=~_|!:,.;]*[-a-zA-Z0-9+&@#/%=~_|]")) {
        if (res == null)
          res = new LinkedHashSet<>(); 
        res.add(new FormValidationError((Entry)this.currentExternalConfigEntry, "venueManagementURL", (Control)this.txtVenueManagementURL, getMessage("validation.invalidURL")));
      } 
      if (StringUtils.isNotBlank(this.txtVenueManagementURL.getText()) && StringUtils.isBlank(this.txtVenueManagementRingNumber.getText())) {
        if (res == null)
          res = new LinkedHashSet<>(); 
        res.add(new FormValidationError((Entry)this.currentExternalConfigEntry, "txtVenueManagementRingNumber", (Control)this.txtVenueManagementRingNumber, getMessage("validation.required")));
      } 
    } 
    if (this.cmbScreenRessolution.getValue() == null || StringUtils.isBlank((CharSequence)this.cmbScreenRessolution.getValue())) {
      if (res == null)
        res = new LinkedHashSet<>(); 
      res.add(new FormValidationError((Entry)this.currentExternalConfigEntry, "extScoreboardResolution", (Control)this.cmbScreenRessolution, getMessage("validation.required")));
    } 
      ...
      if (listenerTextfields != null)
        for (Control listenerTextfield : listenerTextfields) {
          ...
          if (StringUtils.isBlank(textField.getText())) {
            if (res == null)
              res = new LinkedHashSet<>(); 
            res.add(new FormValidationError((Entry)this.currentExternalConfigEntry, "eventsListenerURL", (Control)textField, getMessage("validation.required")));
            continue;
          } 
          if (!textField.getText().matches("^(https?|ftp|file)://[-a-zA-Z0-9+&@#/%?=~_|!:,.;]*[-a-zA-Z0-9+&@#/%=~_|]")) {
            if (res == null)
              res = new LinkedHashSet<>(); 
            res.add(new FormValidationError((Entry)this.currentExternalConfigEntry, "eventsListenerURL", (Control)textField, getMessage("validation.invalidURL")));
          } 
        }  
    } 
    return res;
    ...
    if (isFormValid()) {
      ...
      TkStrikeExecutors.executeInThreadPool(new Callable<Void>() {
            public Void call() throws Exception {
              ArrayList<String> strings = ConfigurationExternalConfigController.this.getListenersTextfieldValues(ConfigurationExternalConfigController.this.pnEventListeners);
              if (strings != null)
                ConfigurationExternalConfigController.this.currentExternalConfigEntry.setListenersURLs(strings); 
              strings = ConfigurationExternalConfigController.this.getListenersTextfieldValues(ConfigurationExternalConfigController.this.pnNodeEventListeners);
              if (strings != null)
                ConfigurationExternalConfigController.this.currentExternalConfigEntry.setNodeListenersURLs(strings); 
              try {
                ConfigurationExternalConfigController.this.externalConfigService.update(ConfigurationExternalConfigController.this.currentExternalConfigEntry.createExternalConfig());
                ConfigurationExternalConfigController.this.getAppStatusWorker().externalScreenResolutionProperty().set(ScreenResolution.valueOf(ConfigurationExternalConfigController.this.currentExternalConfigEntry.getExtScoreboardResolution()));
              } catch (TkStrikeServiceException e) {
                ConfigurationExternalConfigController.this.showProgressIndicator(false);
                ConfigurationExternalConfigController.this.manageException((Throwable)e, "Saving external config", null);
                return null;
              } 
    ...
    if (StringUtils.isNotBlank(this.txtWTOvrUrl.getText())) {
      ...
      TkStrikeExecutors.executeInThreadPool(new Callable<Void>() {
            public Void call() throws Exception {
              ...
              try {
                testResult = ConfigurationExternalConfigController.this.wtOvrClientService.doPing(ConfigurationExternalConfigController.this.txtWTOvrUrl.getText(), ConfigurationExternalConfigController.this.txtWTOvrXApiKey.getText());
              } catch (Exception e) {
              ...
              Platform.runLater(new Runnable() {
                    public void run() {
                      ...
                      if (testResultFinal.booleanValue()) {
                        ConfigurationExternalConfigController.this.showInfoDialog(ConfigurationExternalConfigController.this.getMessage("title.default.info"), ConfigurationExternalConfigController.this.getMessage("message.info.wtOvrTestOk"));
                      } else {
                        ConfigurationExternalConfigController.this.showErrorDialog(ConfigurationExternalConfigController.this.getMessage("title.default.error"), ConfigurationExternalConfigController.this.getMessage("message.error.wtOvrTest"));
                      } 
                    }
                  });
              return null;
  ...
  public void testVenueManagementConn() {
    ...
    TkStrikeExecutors.executeInThreadPool(new Callable<Void>() {
          public Void call() throws Exception {
            Boolean testResult = Boolean.FALSE;
            try {
              testResult = ConfigurationExternalConfigController.this.venueManagementClient.doPing(ConfigurationExternalConfigController.this.txtVenueManagementURL.getText());
              if (testResult == null)
            ...
            Platform.runLater(new Runnable() {
                  public void run() {
                    ConfigurationExternalConfigController.this.showProgressIndicator(false);
                    if (testResultFinal.booleanValue()) {
                      ConfigurationExternalConfigController.this.showInfoDialog(ConfigurationExternalConfigController.this.getMessage("title.default.info"), ConfigurationExternalConfigController.this.getMessage("message.info.venueManagementTestOk"));
                    } else {
                      ConfigurationExternalConfigController.this.showErrorDialog(ConfigurationExternalConfigController.this.getMessage("title.default.error"), ConfigurationExternalConfigController.this.getMessage("message.error.venueManagement"));
                    } 
                  }
                });
            return null;
  ...
  public void doAddNewEventListener() {
    Platform.runLater(new Runnable() {
          public void run() {
            ConfigurationExternalConfigController.this.createNewEventsListenerComponent((String)null, ConfigurationExternalConfigController.this.pnEventListeners, (TkStrikeCommonEventListenerClient)ConfigurationExternalConfigController.this.tkStrikeEventsListenerClient);
          }
        });
  }
  ...
  public void doAddNewNodeEventListener() {
    Platform.runLater(new Runnable() {
          public void run() {
            ConfigurationExternalConfigController.this.createNewEventsListenerComponent((String)null, ConfigurationExternalConfigController.this.pnNodeEventListeners, (TkStrikeCommonEventListenerClient)ConfigurationExternalConfigController.this.tkStrikeNodeEventsListenerClient);
          }
        });
  }
  ...
  public void doAddNewUDPEventListener() {
    ...
    if (StringUtils.isBlank(this.txtUDPListenerIp.getText())) {
      ...
      !this.txtUDPListenerIp.getText().matches("^(([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])\\.){3}([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])$")) {
      isValid = false;
      Platform.runLater(new Runnable() {
            public void run() {
              ConfigurationExternalConfigController.this.txtUDPListenerIp.getStyleClass().removeAll(Collections.singleton("form-default"));
    ...
    if (isValid) {
      initializeUDPFormControlsStyles();
      try {
        UdpEventListenerEntry entry = this.udpEventListenerService.createEntry(this.txtUDPListenerIp.getText(), Integer.valueOf(Integer.parseInt(this.txtUDPListenerPort.getText())));
        if (entry != null) {
  ...
  private void createNewEventsListenerComponent(String defaultURL, final VBox vBoxListeners, final TkStrikeCommonEventListenerClient tkStrikeCommonEventListenerClient) {
    ...
    btTest.getStyleClass().addAll((Object[])new String[] { "button-window" });
          ...
          public void handle(ActionEvent actionEvent) {
            ...
            es.submit(new Runnable() {
                  public void run() {
                    ...
                    try {
                      TextField txtControl = ConfigurationExternalConfigController.this.getURLTextFieldByIndex(vBoxListeners, Integer.valueOf(newIndex));
                      if (txtControl != null) {
                    ...
                    Platform.runLater(new Runnable() {
                          public void run() {
                            ConfigurationExternalConfigController.this.showProgressIndicator(false);
                            if (testResultFinal.booleanValue()) {
                              ConfigurationExternalConfigController.this.showInfoDialog(ConfigurationExternalConfigController.this.getMessage("title.default.info"), ConfigurationExternalConfigController.this.getMessage("message.info.externalEventsListener.testOk"));
                            } else {
                              ConfigurationExternalConfigController.this.showErrorDialog(ConfigurationExternalConfigController.this.getMessage("title.default.error"), ConfigurationExternalConfigController.this.getMessage("message.error.externalEventsListener"));
                            } 
                          }
                        });
                  }
    ...
    btDelete.getStyleClass().addAll((Object[])new String[] { "button-image-delete" });
            ...
            Platform.runLater(new Runnable() {
                  public void run() {
                    ...
                    for (int i = 0; i < vBoxListeners.getChildren().size(); i++) {
                      Node node = (Node)vBoxListeners.getChildren().get(i);
            ...
            Platform.runLater(new Runnable() {
                  public void run() {
                    try {
                      ...
                      ConfigurationExternalConfigController.this.manageException((Throwable)e, "", null);
                    } finally {
                      ConfigurationExternalConfigController.this.showProgressIndicator(false);
                    } 
                  }
  ...
  private TextField getURLTextFieldByIndex(VBox thePaneListeners, Integer index) {
    ...
    for (int i = 0; i < thePaneListeners.getChildren().size(); i++) {
      Node node = (Node)thePaneListeners.getChildren().get(i);
  ...
  public void initialize(URL url, ResourceBundle resourceBundle) {
    ...
    this.cmbScreenRessolution.getItems().addAll((Object[])new String[] { ScreenResolution.HD.toString(), ScreenResolution.FHD
          .toString() });
            ...
            Platform.runLater(new Runnable() {
                  public void run() {
                    if (selected.booleanValue()) {
                      ConfigurationExternalConfigController.this.tgRtBroadcastConnection.setText(ConfigurationExternalConfigController.this.getMessage("toggle.rtBroadcast.connected"));
                    } else {
                      ConfigurationExternalConfigController.this.tgRtBroadcastConnection.setText(ConfigurationExternalConfigController.this.getMessage("toggle.rtBroadcast.notConnected"));
                    } 
                  }
                });
          }
            ...
            if (!ConfigurationExternalConfigController.this.tgRtBroadcastConnection.isSelected()) {
              ...
              if (ConfigurationExternalConfigController.this.isFormValid()) {
                TkStrikeExecutors.executeInThreadPool(new Runnable() {
                      public void run() {
                        try {
                          ConfigurationExternalConfigController.this.rtBroadcastSocketClient.connect(ConfigurationExternalConfigController.this.txtRtBroadcastIp.getText(), Long.valueOf(Long.parseLong(ConfigurationExternalConfigController.this.txtRtBroadcastPort.getText())), ConfigurationExternalConfigController.this.txtRtBroadcastRingNumber.getText());
                        } catch (TkStrikeServiceException e) {
                          e.printStackTrace();
                        } 
                      }
  ...
  public void afterPropertiesSet() throws Exception {
    ...
    this.tgOvrXApiKey.selectedProperty().addListener(new ChangeListener<Boolean>() {
          public void changed(ObservableValue<? extends Boolean> observable, Boolean oldValue, Boolean newValue) {
            ConfigurationExternalConfigController.this.tgOvrXApiKey.setText(ConfigurationExternalConfigController.this.getMessage("toggle.wtOvrUseXApiKey." + (newValue.booleanValue() ? "enabled" : "disabled")));
            if (!newValue.booleanValue())
              ConfigurationExternalConfigController.this.txtWTOvrXApiKey.clear(); 
          }
        });
    this.pnOvrXApiKey.visibleProperty().bind((ObservableValue)this.tgOvrXApiKey.selectedProperty());
    ...
    this.tgWtUdpConnected.selectedProperty().addListener(new ChangeListener<Boolean>() {
          public void changed(ObservableValue<? extends Boolean> observable, Boolean oldValue, final Boolean newValue) {
            Platform.runLater(new Runnable() {
                  public void run() {
                    ConfigurationExternalConfigController.this.tgWtUdpConnected.setText(ConfigurationExternalConfigController.this.getMessage("toggle." + (newValue.booleanValue() ? "connected" : "notConnected")));
                  }
                });
          }
        });
            ...
            if (!ConfigurationExternalConfigController.this.tgWtUdpConnected.isSelected()) {
              ...
              if (ConfigurationExternalConfigController.this.isFormValid()) {
                TkStrikeExecutors.executeInThreadPool(new Runnable() {
                      public void run() {
                        try {
                          ConfigurationExternalConfigController.this.wtUDPService.connect(ConfigurationExternalConfigController.this.txtWTOvrUdpIp.getText(), 
                              Integer.valueOf(Integer.parseInt(ConfigurationExternalConfigController.this.txtWTOvrUdpListenPort.getText())), 
                              Integer.valueOf(Integer.parseInt(ConfigurationExternalConfigController.this.txtWTOvrUdpWritePort.getText())));
                        } catch (TkStrikeServiceException e) {
                          e.printStackTrace();
                        } 
                      }
