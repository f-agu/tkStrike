...
public class NetworkAthletesGroupConfigDto implements Serializable {
  ...
  private SimpleBooleanProperty bodyBlueNodeInitialized = new SimpleBooleanProperty(this, "bodyBlueNodeInitialized", false);
  
  private SimpleBooleanProperty headBlueNodeInitialized = new SimpleBooleanProperty(this, "headBlueNodeInitialized", false);
  
  private SimpleBooleanProperty bodyRedNodeInitialized = new SimpleBooleanProperty(this, "bodyRedNodeInitialized", false);
  
  private SimpleBooleanProperty headRedNodeInitialized = new SimpleBooleanProperty(this, "headRedNodeInitialized", false);
  ...
  private void validateSensors() {
    setBodySensorsEnabled(Boolean.valueOf((this.bodyBlueNodeId != null && this.bodyRedNodeId != null && !"0".equals(this.bodyBlueNodeId) && !"0".equals(this.bodyRedNodeId))));
    setHeadSensorsEnabled(Boolean.valueOf((this.headBlueNodeId != null && this.headRedNodeId != null && !"0".equals(this.headBlueNodeId) && !"0".equals(this.headRedNodeId))));
  }
