...
public class NetworkConfigurationDto implements Serializable {
  ...
  public NetworkAthletesGroupConfigDto getNetworkAthletesGroupConfig(Integer groupNumber) {
    return (groupNumber != null && groupNumber.intValue() > 0 && groupNumber.intValue() <= this.maxGroupsNumber.intValue()) ? this.groupsConfig.get(groupNumber) : null;
  }
  ...
  private boolean isAthleteGroupConfigAllInitialized(NetworkAthletesGroupConfigDto networkAthletesGroupConfigDto) {
    return (networkAthletesGroupConfigDto != null && ((networkAthletesGroupConfigDto
      ...
      .getBodyBlueNodeId() != null && !"0".equals(networkAthletesGroupConfigDto.getBodyBlueNodeId()) && networkAthletesGroupConfigDto
      .getBodyRedNodeId() != null && !"0".equals(networkAthletesGroupConfigDto.getBodyRedNodeId())) || (networkAthletesGroupConfigDto
      
      .getHeadBlueNodeId() != null && !"0".equals(networkAthletesGroupConfigDto.getHeadBlueNodeId()) && networkAthletesGroupConfigDto
      .getHeadRedNodeId() != null && !"0".equals(networkAthletesGroupConfigDto.getHeadRedNodeId()))));
  }
}
