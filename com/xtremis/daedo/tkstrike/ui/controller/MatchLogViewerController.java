...
public class MatchLogViewerController extends TkStrikeBaseController {
		...
		TkStrikeExecutors.executeInThreadPool(new Runnable() {
			...
			public void run() {
				try {
					...
					TkStrikeBaseController.logger.info("MatchLogViewerController - matchLogId ->" + MatchLogViewerController.this.matchLogId
							+ " isHistorical?" + MatchLogViewerController.this.isHistorical);
					MatchLogDto matchLog = null;
					if( ! MatchLogViewerController.this.isHistorical.booleanValue()) {
						matchLog = MatchLogViewerController.this.matchLogService.getById(MatchLogViewerController.this.matchLogId);
					} else {
						matchLog = MatchLogViewerController.this.matchLogHistoricalService.getMatchLog(MatchLogViewerController.this.matchLogId);
					}
					if(matchLog != null) {
			...
			Platform.runLater(new Runnable() {
				...
				public void run() {
					try {
						...
						MatchLogViewerController.this.lblPhaseInfo.setText(MatchLogViewerController.this.getMessage("message.phaseWithDiffScore",
								new String[] {matchLog.getPhaseName(), "" + matchLog.getDifferencialScore()}));
						MatchLogViewerController.this.lblCategory.setText(matchLog.getSubCategoryName() + " " + matchLog
								.getCategoryGender().toString() + " " + matchLog
										.getCategoryName());
						MatchLogViewerController.this.lblMaxGamJeomsAllowed.setText((matchLog.getMaxAllowedGamJeoms() != null && matchLog
								.getMaxAllowedGamJeoms().intValue() > 0) ? ("" + matchLog.getMaxAllowedGamJeoms()) : "-");
						MatchLogViewerController.this.lblBlueInfo.setText(matchLog.getBlueAthleteName() + " - " + ((matchLog
								.getBlueAthleteFlagAbbreviation() != null) ? ((matchLog.getBlueAthleteFlagShowName() != null && matchLog
										.getBlueAthleteFlagShowName().booleanValue()) ? matchLog.getBlueAthleteFlagName()
												: matchLog.getBlueAthleteFlagAbbreviation()) : ""));
						MatchLogViewerController.this.ivBlueInfo.setImage(MatchLogViewerController.this._getImageByPath(matchLog
								.getBlueAthleteFlagImagePath()));
						...
						MatchLogViewerController.this.lblRedInfo.setText(matchLog.getRedAthleteName() + " - " + ((matchLog
								.getRedAthleteFlagAbbreviation() != null) ? ((matchLog.getRedAthleteFlagShowName() != null && matchLog
										.getRedAthleteFlagShowName().booleanValue()) ? matchLog.getRedAthleteFlagName()
												: matchLog.getRedAthleteFlagAbbreviation()) : ""));
						MatchLogViewerController.this.ivRedInfo.setImage(MatchLogViewerController.this._getImageByPath(matchLog
								.getRedAthleteFlagImagePath()));
						...
						if(matchLog.getMatchStartTime() != null && matchLog.getMatchStartTime().longValue() > 0L) {
							MatchLogViewerController.this.lblStartTime.setText(MatchLogViewerController.this.getDfFullFormat().format(new Date(
									matchLog.getMatchStartTime().longValue())));
						} else {
							MatchLogViewerController.this.lblStartTime.setText("");
						}
						if(matchLog.getMatchEndTime() != null && matchLog.getMatchEndTime().longValue() > 0L) {
							MatchLogViewerController.this.lblEndTime.setText(MatchLogViewerController.this.getDfFullFormat().format(new Date(matchLog
									.getMatchEndTime().longValue())));
						} else {
	...
	public void doExportToCSV() {
		...
		File targetDirectory = this.directoryChooser.showDialog(getCurrentStage());
		if(targetDirectory != null)
			try {
				...
				manageException(e, "doExportToCSV", null);
			}
	}
	...
	public void afterPropertiesSet() throws Exception {
		...
		this.colRoundNumber.setCellValueFactory(new PropertyValueFactory("roundNumberStr"));
		this.colRoundTime.setCellValueFactory(new PropertyValueFactory("roundTime"));
		...
		this.colSystemTime.setCellValueFactory(new PropertyValueFactory("eventTime"));
		this.colSystemTime.setCellFactory(TextFieldTableCell.forTableColumn((StringConverter)new TimestampToStringConverter(
				this.dfFullFormatPattern)));
		this.colEventType.setCellValueFactory(new PropertyValueFactory("matchLogItemType"));
		...
		this.colEntryValue.setCellValueFactory(new PropertyValueFactory("entryValue"));
		...
		this.colScore.setCellValueFactory(new Callback<TableColumn.CellDataFeatures<CommonMatchLogItemDto, String>, ObservableValue<String>>() {
			...
			public ObservableValue<String> call(TableColumn.CellDataFeatures<CommonMatchLogItemDto, String> matchLogItemEntryStringCellDataFeatures) {
				...
				CommonMatchLogItemDto matchLogItemEntry = matchLogItemEntryStringCellDataFeatures.getValue();
	...
	private class SensorHitCellValuePropertyFactory
			implements Callback<TableColumn.CellDataFeatures<CommonMatchLogItemDto, Pane>, ObservableValue<Pane>> {
		...
		public ObservableValue<Pane> call(TableColumn.CellDataFeatures<CommonMatchLogItemDto, Pane> param) {
			...
			CommonMatchLogItemDto matchLogItemEntry = param.getValue();
			if(matchLogItemEntry != null &&
					validForMatchLogItemEntry(matchLogItemEntry).booleanValue())
				if( ! this.judge.booleanValue() && (MatchLogItemType.BLUE_VIDEO_REQUEST.equals(matchLogItemEntry.getMatchLogItemType())
						|| MatchLogItemType.BLUE_VIDEO_QUOTA_CHANGED
					...
					if((this.blue.booleanValue() && MatchLogItemType.BLUE_VIDEO_REQUEST.equals(matchLogItemEntry.getMatchLogItemType()))
						...
						Text text = new Text("?");
						text.getStyleClass().addAll(new String[] {"matchLogVideoRequestCellText"});
						...
						container.getChildren().add(text);
							...
							|| ( ! this.blue.booleanValue() && MatchLogItemType.RED_VIDEO_QUOTA_CHANGED.equals(matchLogItemEntry
									.getMatchLogItemType()))) {
						Rectangle rectangle = new Rectangle();
						rectangle.setWidth(30.0D);
						rectangle.setHeight(30.0D);
		...
		private Boolean validForMatchLogItemEntry(CommonMatchLogItemDto matchLogItemEntry) {
			...
			if(matchLogItemEntry != null && (MatchLogItemType.BLUE_BODY_HIT.equals(matchLogItemEntry.getMatchLogItemType())
					|| MatchLogItemType.OT_BLUE_BODY_HIT
											...
											.equals(matchLogItemEntry.getMatchLogItemType()) || MatchLogItemType.BLUE_JUDGE_BODY_TECH
													.equals(matchLogItemEntry.getMatchLogItemType()) || MatchLogItemType.OT_BLUE_JUDGE_BODY_TECH
															.equals(matchLogItemEntry.getMatchLogItemType()) || MatchLogItemType.BLUE_JUDGE_HEAD_TECH
																	.equals(matchLogItemEntry.getMatchLogItemType())
					|| MatchLogItemType.OT_BLUE_JUDGE_HEAD_TECH
							.equals(matchLogItemEntry.getMatchLogItemType()) || MatchLogItemType.BLUE_JUDGE_SPECIAL_HEAD_HIT
									.equals(matchLogItemEntry.getMatchLogItemType()) || MatchLogItemType.OT_BLUE_JUDGE_SPECIAL_HEAD_HIT
											.equals(matchLogItemEntry.getMatchLogItemType()) || MatchLogItemType.BLUE_JUDGE_SPECIAL_BODY_HIT
													.equals(matchLogItemEntry.getMatchLogItemType())
					|| MatchLogItemType.OT_BLUE_JUDGE_SPECIAL_BODY_HIT
											...
											.equals(matchLogItemEntry.getMatchLogItemType()) || MatchLogItemType.BLUE_VIDEO_REQUEST
													.equals(matchLogItemEntry.getMatchLogItemType()) || MatchLogItemType.BLUE_VIDEO_QUOTA_CHANGED
															.equals(matchLogItemEntry.getMatchLogItemType()) || MatchLogItemType.RED_BODY_HIT
																	.equals(matchLogItemEntry.getMatchLogItemType())
					|| MatchLogItemType.OT_RED_BODY_HIT
											...
											.equals(matchLogItemEntry.getMatchLogItemType()) || MatchLogItemType.RED_ADD_KYONG_GO
													.equals(matchLogItemEntry.getMatchLogItemType()) || MatchLogItemType.RED_ADD_GAME_JEON
															.equals(matchLogItemEntry.getMatchLogItemType()) || MatchLogItemType.RED_REMOVE_KYONG_GO
																	.equals(matchLogItemEntry.getMatchLogItemType())
					|| MatchLogItemType.RED_REMOVE_GAME_JEON
											...
											.equals(matchLogItemEntry.getMatchLogItemType()) || MatchLogItemType.RED_JUDGE_BODY_TECH
													.equals(matchLogItemEntry.getMatchLogItemType()) || MatchLogItemType.OT_RED_JUDGE_BODY_TECH
															.equals(matchLogItemEntry.getMatchLogItemType()) || MatchLogItemType.RED_JUDGE_HEAD_TECH
																	.equals(matchLogItemEntry.getMatchLogItemType())
					|| MatchLogItemType.OT_RED_JUDGE_HEAD_TECH
									...
									.equals(matchLogItemEntry.getMatchLogItemType()) || MatchLogItemType.OT_RED_JUDGE_SPECIAL_HEAD_HIT
											.equals(matchLogItemEntry.getMatchLogItemType()) || MatchLogItemType.RED_JUDGE_SPECIAL_BODY_HIT
													.equals(matchLogItemEntry.getMatchLogItemType()) || MatchLogItemType.OT_RED_JUDGE_SPECIAL_BODY_HIT
															.equals(matchLogItemEntry.getMatchLogItemType())
					|| MatchLogItemType.RED_JUDGE_SPECIAL_HEAD_TECH
											...
											.equals(matchLogItemEntry.getMatchLogItemType()) || MatchLogItemType.RED_REMOVE_NEAR_MISS_HIT
													.equals(matchLogItemEntry.getMatchLogItemType()) || MatchLogItemType.BLUE_ADD_NEAR_MISS_HIT
															.equals(matchLogItemEntry.getMatchLogItemType()) || MatchLogItemType.RED_ADD_NEAR_MISS_HIT
																	.equals(matchLogItemEntry.getMatchLogItemType())
					|| MatchLogItemType.RED_VIDEO_REQUEST
							.equals(matchLogItemEntry.getMatchLogItemType()) || MatchLogItemType.RED_VIDEO_QUOTA_CHANGED
									.equals(matchLogItemEntry.getMatchLogItemType()) || MatchLogItemType.BLUE_PARA_TURNING_KICK
											...
											.equals(matchLogItemEntry.getMatchLogItemType()) || MatchLogItemType.RED_PARA_TURNING_KICK
													.equals(matchLogItemEntry.getMatchLogItemType()) || MatchLogItemType.OT_BLUE_PARA_TURNING_KICK
															.equals(matchLogItemEntry.getMatchLogItemType())
					|| MatchLogItemType.OT_RED_PARA_TURNING_KICK
						...
						if(StringUtils.isNumeric(matchLogItemEntry.getEntryValue()) && this.judgeNumber
								.intValue() == Integer.parseInt(matchLogItemEntry.getEntryValue()) && (MatchLogItemType.BLUE_JUDGE_PUNCH
										...
										|| MatchLogItemType.BLUE_JUDGE_SPECIAL_HEAD_HIT
												.equals(matchLogItemEntry.getMatchLogItemType()) || MatchLogItemType.BLUE_JUDGE_SPECIAL_BODY_HIT
														.equals(matchLogItemEntry.getMatchLogItemType())
										|| MatchLogItemType.BLUE_JUDGE_SPECIAL_HEAD_TECH
												.equals(matchLogItemEntry.getMatchLogItemType()) || MatchLogItemType.OT_BLUE_JUDGE_PUNCH
														.equals(matchLogItemEntry.getMatchLogItemType()) || MatchLogItemType.OT_BLUE_JUDGE_BODY_TECH
																.equals(matchLogItemEntry.getMatchLogItemType())
										|| MatchLogItemType.OT_BLUE_JUDGE_HEAD_TECH
										...
										|| MatchLogItemType.OT_BLUE_JUDGE_SPECIAL_BODY_HIT
												.equals(matchLogItemEntry.getMatchLogItemType()) || MatchLogItemType.OT_BLUE_JUDGE_SPECIAL_HEAD_TECH
														.equals(matchLogItemEntry.getMatchLogItemType()) || MatchLogItemType.BLUE_PARA_TURNING_KICK
																...
																.equals(matchLogItemEntry.getMatchLogItemType())
										|| MatchLogItemType.OT_BLUE_PARA_TURNING_KICK
												.equals(matchLogItemEntry.getMatchLogItemType()) || MatchLogItemType.BLUE_PARA_SPINNING_KICK
														.equals(matchLogItemEntry.getMatchLogItemType())
										|| MatchLogItemType.OT_BLUE_PARA_SPINNING_KICK
												.equals(matchLogItemEntry.getMatchLogItemType())))
							res = Boolean.TRUE;
		...
		private Shape getShapeForItemType(MatchLogItemType matchLogItemType) {
			...
			switch(matchLogItemType) {
				...
				case OT_RED_PARA_SPINNING_KICK:
					polygon = new Polygon();
					polygon.getPoints().addAll(new Double[] {Double.valueOf( - 15.0D), Double.valueOf(15.0D),
		...
		private Text getTextForMatchIntemEntry(CommonMatchLogItemDto matchLogItemEntry) {
			...
			if(MatchLogItemType.BLUE_BODY_HIT.equals(matchLogItemEntry.getMatchLogItemType()) || MatchLogItemType.BLUE_HEAD_HIT
				...
				text.getStyleClass().addAll(new String[] {"matchLogHitCellText"});
	...
	private class PointsCellValuePropertyFactory
			implements Callback<TableColumn.CellDataFeatures<CommonMatchLogItemDto, Pane>, ObservableValue<Pane>> {
		...
		public ObservableValue<Pane> call(TableColumn.CellDataFeatures<CommonMatchLogItemDto, Pane> param) {
			...
			container.setMaxHeight(30.0D);
			container.setAlignment(Pos.CENTER);
			addChildrensIfNeed(param.getValue(), container);
			res.set(container);
			return res;
		}
		...
		private void addChildrensIfNeed(CommonMatchLogItemDto matchLogItemEntry, StackPane container) {
			if(matchLogItemEntry != null && ((this.blue
					.booleanValue() && matchLogItemEntry.getBlueAddPoints().intValue() != 0) || ( ! this.blue.booleanValue() && matchLogItemEntry
							.getRedAddPoints().intValue() != 0))) {
				...
				recPoints.setStroke(Color.WHITE);
				recPoints.setStrokeWidth(2.0D);
				container.getChildren().add(recPoints);
				Text text = new Text(getStringForAddPoints((this.blue.booleanValue() ? matchLogItemEntry.getBlueAddPoints()
						: matchLogItemEntry.getRedAddPoints()).intValue()));
				text.getStyleClass().addAll(new String[] {"matchLogHitCellText"});
				text.setFill(Color.WHITE);
				container.getChildren().add(text);
			}
