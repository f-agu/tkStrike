...
public class ConfigurationSoundsController extends TkStrikeBaseController {
	...
	private void _bindControls() {
		this.chkBSR.selectedProperty().bindBidirectional(this.soundConfigurationEntry.soundBeforeStartRoundProperty().get().enabledProperty());
		...
		this.cmbVolumeBSR.valueProperty().bindBidirectional(this.soundConfigurationEntry.soundBeforeStartRoundProperty().get().soundVolumeProperty());
		this.txtBSR.textProperty().bindBidirectional(this.soundConfigurationEntry.soundBeforeStartRoundProperty().get().nameProperty());
		this.chkEOT.selectedProperty().bindBidirectional(this.soundConfigurationEntry.soundEndOfTimeProperty().get().enabledProperty());
		this.cmbVolumeEOT.valueProperty().bindBidirectional(this.soundConfigurationEntry.soundEndOfTimeProperty().get().soundVolumeProperty());
		this.txtEOT.textProperty().bindBidirectional(this.soundConfigurationEntry.soundEndOfTimeProperty().get().nameProperty());
		this.chkWBH.selectedProperty().bindBidirectional(this.soundConfigurationEntry.soundWhenBodyHitProperty().get().enabledProperty());
		this.cmbVolumeWBH.valueProperty().bindBidirectional(this.soundConfigurationEntry.soundWhenBodyHitProperty().get().soundVolumeProperty());
		this.txtWBH.textProperty().bindBidirectional(this.soundConfigurationEntry.soundWhenBodyHitProperty().get().nameProperty());
		this.chkWHH.selectedProperty().bindBidirectional(this.soundConfigurationEntry.soundWhenHeadHitProperty().get().enabledProperty());
		this.cmbVolumeWHH.valueProperty().bindBidirectional(this.soundConfigurationEntry.soundWhenHeadHitProperty().get().soundVolumeProperty());
		this.txtWHH.textProperty().bindBidirectional(this.soundConfigurationEntry.soundWhenBodyHitProperty().get().nameProperty());
		this.chkWKG.selectedProperty().bindBidirectional(this.soundConfigurationEntry.soundWhenKyongGoProperty().get().enabledProperty());
		this.cmbVolumeWKG.valueProperty().bindBidirectional(this.soundConfigurationEntry.soundWhenKyongGoProperty().get().soundVolumeProperty());
		this.txtWKG.textProperty().bindBidirectional(this.soundConfigurationEntry.soundWhenKyongGoProperty().get().nameProperty());
		this.chkWGJ.selectedProperty().bindBidirectional(this.soundConfigurationEntry.soundWhenGameJeonProperty().get().enabledProperty());
		this.cmbVolumeWGJ.valueProperty().bindBidirectional(this.soundConfigurationEntry.soundWhenGameJeonProperty().get().soundVolumeProperty());
		this.txtWGJ.textProperty().bindBidirectional(this.soundConfigurationEntry.soundWhenGameJeonProperty().get().nameProperty());
		this.chkWTM.selectedProperty().bindBidirectional(this.soundConfigurationEntry.soundWhenTechMeetingProperty().get().enabledProperty());
		this.cmbVolumeWTM.valueProperty().bindBidirectional(this.soundConfigurationEntry.soundWhenTechMeetingProperty().get().soundVolumeProperty());
		this.txtWTM.textProperty().bindBidirectional(this.soundConfigurationEntry.soundWhenTechMeetingProperty().get().nameProperty());
	}

	public void save() {
		try {
			this.soundConfigurationService.update(this.soundConfigurationEntry);
			doCloseThisStage();
		} catch(TkStrikeServiceException e) {
			manageException(e, "SaveConfigurationSounds", null);
		}
	}
	...
	private void _changeSoundFile(SoundConfigurationItemEntry soundConfigurationItemEntry) {
		if(soundConfigurationItemEntry != null) {
			...
			this.fileChooser.getExtensionFilters().addAll(new FileChooser.ExtensionFilter[] {new FileChooser.ExtensionFilter("MP3", new String[] {
					"*.mp3"}), new FileChooser.ExtensionFilter("WAV", new String[] {"*.wav"})});
			File newSoundOrigFile = this.fileChooser.showOpenDialog(getCurrentStage());
	...
	public void initialize(URL url, ResourceBundle resourceBundle) {
		...
		this.btPlayBSR.setGraphic(new ImageView(new Image(getClass().getResourceAsStream("/images/ic_play.png"))));
		this.btPlayEOT.setGraphic(new ImageView(new Image(getClass().getResourceAsStream("/images/ic_play.png"))));
		this.btPlayWBH.setGraphic(new ImageView(new Image(getClass().getResourceAsStream("/images/ic_play.png"))));
		this.btPlayWHH.setGraphic(new ImageView(new Image(getClass().getResourceAsStream("/images/ic_play.png"))));
		this.btPlayWKG.setGraphic(new ImageView(new Image(getClass().getResourceAsStream("/images/ic_play.png"))));
		this.btPlayWGJ.setGraphic(new ImageView(new Image(getClass().getResourceAsStream("/images/ic_play.png"))));
		this.btPlayWTM.setGraphic(new ImageView(new Image(getClass().getResourceAsStream("/images/ic_play.png"))));
	}
