...
public class TkStrikeSpringConfiguration extends BaseTkStrikeSpringConfiguration {
  ...
  public TkStrikeCommunicationService getTkStrikeCommunicationServiceDefault() {
    return (TkStrikeCommunicationService)new TkStrikeCommunicationServiceImpl();
  }
  ...
  public TkStrikeExtraCommunicationServiceImpl getTkStrikeExtraCommunicationService() {
    System.out.println("Creates TkStrikeExtraCommunicationServiceImpl ");
  ...
  public RoundFinishedConfirmationController roundFinishedConfirmationController() throws IOException {
    return (RoundFinishedConfirmationController)loadController((TkStrikeController)new RoundFinishedConfirmationController(), "/META-INF/fxml/RoundFinishedConfirmation.fxml");
  }
  ...
  public ConfigurationNetworkController getConfigurationNetworkController() throws IOException {
    return (ConfigurationNetworkController)loadController("/META-INF/fxml/configuration/Configuration-Network.fxml");
  }
  ...
  public ConfigurationExternalConfigController getConfigurationExternalConfigController() throws IOException {
    return (ConfigurationExternalConfigController)loadController("/fxml/configuration/Configuration-ExternalConfig.fxml");
  }
  ...
  public ConfigurationSoftwareUpdateController getConfigurationSoftwareUpdateController() throws IOException {
    return (ConfigurationSoftwareUpdateController)loadController("/fxml/configuration/Configuration-SoftwareUpdate.fxml");
  }
  ...
  @Bean
  public DifferentialScoreDefinitionManagementController getDifferentialScoreDefinitionManagementController() throws IOException {
    return (DifferentialScoreDefinitionManagementController)loadController("/fxml/ringmanager/DifferentialScoreDefinitionManagement.fxml");
  }
  
  @Bean
  public MatchConfigurationManagementController getMatchConfigurationManagementController() throws IOException {
    return (MatchConfigurationManagementController)loadController("/fxml/ringmanager/MatchConfigurationsManagement.fxml");
  }
